        ...
        <div className="projects">
          <section>
            ...
            <p className="project-description">
              A website I designed for my artist friend Fruit Melody.
            </p>
          ...
          <section>
            ...
            <h3>Connect 4</h3>
            <a
              className="b-view-project"
              href="https://pcchiu96.github.io/connect-4"
            >
              View Project
            </a>
            <p className="project-description">
              A 2-player board game that I built to practice coding in ReactJS.
            </p>
            <p className="language-icons">
          ...
          <section>
            ...
            <a
              className="b-view-code"
              href="https://github.com/pcchiu96/discord-werewolf-bot"
            >
              <i className="fa fa-github" aria-hidden="true"></i> View Code
            </a>
            <p className="project-description">
              A discord werewolf game that is similar to mafia but with a fun
              twist.
            </p>
            <p className="language-icons">
          ...
          <section>
            ...
            <a
              className="b-view-code"
              href="https://github.com/pcchiu96/discord-emoji-tracker"
            >
              <i className="fa fa-github" aria-hidden="true"></i> View Code
            </a>
            <p className="project-description">
              A discord emoji tracker that my discord group used weekly to find
              the popularity of each custom emoji.
            </p>
            <p className="language-icons">
              <i className="devicon-nodejs-plain colored" title="NodeJS"></i>
              <i
          ...
          <section>
            ...
            <a
              className="b-view-project"
              href="https://pcchiu96.github.io/unlock-code"
            >
              View Project
            </a>
            <p className="project-description">
              This is just a fun little project I made to see if I can replicate
              what Snowden said about passwords under 8 characters can be solved
              under a second but with numbers.
            </p>
            <p className="language-icons">
              <i
                className="devicon-javascript-plain colored"
          ...
          <section>
            ...
            <a
              className="b-view-project"
              href="https://www.tigerapplicationsllc.com/index.php?page=index"
            >
              View Project
            </a>
            <p className="project-description">
              A work in progress website I designed and built for Tiger
              Applications LLC.
            </p>
            <p className="language-icons">
              ...
              <i className="devicon-html5-plain colored" title="HTML5"></i>
              <i
                className="devicon-less-plain-wordmark colored"
                title="LESS"
              ></i>
              <i className="devicon-css3-plain colored" title="CSS3"></i>
            </p>
