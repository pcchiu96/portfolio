            ...
            <div className='projects-wrapper'>
                <div className='projects'>
                    ...
                    <section>
                        ...
                        <a className='b-view-project' href='https://www.tigerapplicationsllc.com/index.php?page=index'>
                            View Project
                        </a>
                        <p className='project-description'>A work in progress website I designed and built for Tiger Applications LLC.</p>
                        <p className='language-icons'>
